    ...
    <div className="fixed inset-0 z-10 flex min-h-svh bg-tv-bg">
      ...
      <div className="flex w-full flex-col items-center justify-center px-6 lg:w-1/2">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8 text-center">
            ...
            <h1 className="mb-2 text-2xl font-semibold text-white">{t(m, 'forgotPassword.heading')}</h1>
            <p className="text-tv-muted">
              {t(m, 'forgotPassword.subtitle')}
            </p>
          </div>

          <ForgotPasswordForm serverError={error} serverSuccess={success} />

          {/* Back to login */}
          <p className="mt-6 text-center text-sm text-tv-muted">
            {t(m, 'forgotPassword.rememberPassword')}{' '}
            <Link href="/login" className="text-tv-link hover:text-tv-link-hover">
              {t(m, 'forgotPassword.backToLoginLink')}
            </Link>
          </p>
      ...
      <div className="relative hidden overflow-hidden lg:flex lg:w-1/2 lg:flex-col lg:items-center lg:justify-center">
        ...
        <div className="relative z-10 max-w-md px-12 text-center">
          ...
          <h2 className="mb-4 text-3xl font-semibold text-white">{t(m, 'forgotPassword.desktopHeading')}</h2>
          <p className="mb-10 text-tv-muted">
            {t(m, 'forgotPassword.desktopSubtitle')}
          </p>
